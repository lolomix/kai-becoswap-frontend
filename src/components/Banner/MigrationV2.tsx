...
import { Text, Flex, Box, ErrorIcon, Button } from '@becoswap-libs/kai-uikit'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any BecoSwap LP tokens and BecoSwap farms.
        </Text>

...
import { Flex, Text, Skeleton } from '@becoswap-libs/kai-uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, account }) => {
  ...
  return (
    <FCard>
      {farm.token.symbol === 'BECO' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          removed={removed}
          bscScanAddress={`https://explorer.kardiachain.io/address/${farm.lpAddresses[process.env.REACT_APP_CHAIN_ID]}`}
          infoAddress={`https://kaidex.io/exchange/${lpAddress}`}

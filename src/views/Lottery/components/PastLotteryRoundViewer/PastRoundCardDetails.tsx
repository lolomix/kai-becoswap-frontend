...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@becoswap-libs/kai-uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={t(`${poolSize.toLocaleString()} BECO`)} Icon={PancakeRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>

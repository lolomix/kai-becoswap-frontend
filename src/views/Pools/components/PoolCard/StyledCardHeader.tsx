...
import { CardHeader, Heading, Text, Flex, Image } from '@becoswap-libs/kai-uikit'
...
const StyledCardHeader: React.FC<{
  ...
  const isCakePool = earningTokenSymbol === 'BECO' && stakingTokenSymbol === 'BECO'

...
import { Flex, Text, Link, Heading } from '@becoswap-libs/kai-uikit'
  ...
  return (
    <StyledBetDetails>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="8px">
        ...
        <Link href={`https://explorer.kardiachain.io/block/${bet.round.lockBlock}`} external>
          {bet.round.lockBlock}
        </Link>
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text>{t('Closing Block')}</Text>
        <Link href={`https://explorer.kardiachain.io/block/${bet.round.endBlock}`} external>
          {bet.round.endBlock}
        </Link>
      </Flex>
    </StyledBetDetails>

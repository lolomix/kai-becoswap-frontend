...
import { Heading, Text, Flex, ChevronRightIcon } from '@becoswap-libs/kai-uikit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the BecoSwap platform.')}
      </Text>
      <Text as="p">
